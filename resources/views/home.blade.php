...
@section('content')
   <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li>
      <a href="{{url('/contactadmin')}}" class="app-menu__item ">Contact</a>
        </li>
         <li>
        <a href="{{url('/news-feed')}}" class="app-menu__item">News Feed</a>
        </li>
        <li>
        <a href="{{url('/career-post')}}" class="app-menu__item">Post Job Profile</a>
        </li>
        <li>
        <a href="{{url('/career-applicant')}}" class="app-menu__item">Career Applicant</a>
        </li> 
        <li>
        <a href="{{url('/add-mail-career')}}" class="app-menu__item">Addmail</a>
        </li>
      </ul>
    </aside>
