			...
			<div id="page-title">
			  ...
			  <div class="container">
			    <div class="sixteen columns">
			      <h1>Value Added Product strategies</h1>
			    </div>
			  </div>
			  <!--  Container End -->
	...
	<section>
		<div id="Service">
			...
			<div class="container">
				...
				<h3>Value Added Product strategies</h3>
					<p>
					...
					<p>
						The entire school should become a learning laboratory.<br>
						Having a stress free atmosphere<br>
						Encouraging creativity<br>
						Confidence building<br>
						Inculcate values<br>
						To encourage children to pursue the career of their choice<br>
						Quality control is maintained<br>
				...
				<div class="col-xs-12 colsm-4 col-md-4 col-lg-4">
					<img src="{{asset('images/value-added-product-strategy(360x240).jpg')}}" class="img-responsive service-img1">
				</div>
			</div>
		</div>
	</section>
