...
@section('title','CBSE School Building Plan, How to Open CBSE school, New CBSE School Planning')
@section('meta')
		<meta name="description" content="Our professinal consultants can assist you to make new CBSE school planning, building plan and board affiliation."/> 
		
		<meta name="keywords" content="new CBSE school planning, cbse school building plan, start a new school in India, how to open cbse school, consultants for opening schools"/>
@endsection
@section('content')
	<!--  Page Title -->
			<div id="page-title">
	...
	<section>
		<div id="Service">
			...
			<div class="container">
				...
				<h3>School Planning/Construction Assistance/PMC</h3>
					...
					<ul class="arrow_list">
				        ...
				        <li>Feasibility report & Project plan  </li>
				        <li>Financial model </li>
				        <li>Finance structuring and options  </li>
				    </ul>

				    <h4>Construction Assistance/PMC-</h4>
                     <p>
				...
				<div class="col-xs-12 colsm-4 col-md-4 col-lg-4">
					<img src="{{asset("images/school-planning(360x240).jpg")}}" class="img-responsive service-img1">
				</div>
			</div>
		</div>
	</section>
