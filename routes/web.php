...
Route::view('/feasibility-study-report', 'pages.feasibility-study_report');
Route::view('/rail-traffic-clearance', 'pages.rail_traffic-clearance');
...
Route::view('/3d-mapping-survey', 'pages.d3_mapping-survey');
Route::view('/drone-uav-survey', 'pages.drone_uav-survey');
...
Route::view('/smart-city-survey', 'pages.smart_city-survey');
...
Route::view('/energy-efficiency-and-power-consultancy', 'pages.energy-efficiency-and_power-consultancy');
...
Route::view('/captive-powerplant', 'pages.captive-powerplant');
...
Route::view('/value-added-product-strategies', 'pages.value-added_product-strategies');
